...
%train_data is the input spectral matrix
%train_labeΪis germination rate
%k is the parameter k in Kfold
%rmsecvis the root mean square error of cross validation
